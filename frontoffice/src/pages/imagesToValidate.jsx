...
class ImagesToValidate extends React.Component {
    ...
    async getImages() {
        ...
        let response = await fetch(this.props.ApiPath + "images/getnonvalidated", requestOptions);
    ...
    async showModal(dd) {
        ...
        let response = await fetch(this.props.ApiPath + "images/getimage", requestOptions);
        let data = await response.json();
    ...
    async validateImage(idImage){
        ...
        let response = await fetch(this.props.ApiPath+"images/validate", requestOptions);
        let data = await response.json();
        console.log(data);
                        ...
                        <div id="PageCentralDiv">
                            ...
                            <div show={this.state.show} className={showHideClassName}>
                                <div className="modal-main">
                                    <img src={"data:image/jpg;base64," + this.state.imageData.mesage} width="400"></img>
                                    <p id="Legenda">{this.state.imageData2.Legenda}</p>
                                    <button id="BTNClose" onClick={() => this.hideModal()}>Fechar</button>
                                </div>
                            </div>

                            <div className="TitleDiv"></div>
                            <p className="TitleP">Imagens a ser validadas</p>
