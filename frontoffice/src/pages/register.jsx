...
class Register extends Component {
  ...
  async register() {
    ...
    if (data.sucess) {
      ...
      div.style.color = "#dc3545";
      this.setState({
        EditStatus: "Houve um erro ao registar utilizador!",
        VerifyStatus: "",
      });
    }
  }
            ...
            <div id="PageCentralDiv">
              ...
              <div id="ProfileBox">
                ...
                <input
                  ...
                  onChange={(this.fixText, this.reload)}
                ></input>
                <h4>Idade</h4>
                <input
                  type="text"
                ...
                <div id="RegButtonsDiv">
                  ...
                  <button className="RegisterBtts" onClick={this.register}>
                    Registar
                  </button>
                </div>
